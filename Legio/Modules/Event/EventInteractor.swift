...
protocol EventInteractorProtocol {
    func getEvents(dislikedEvents: [Int], completion: @escaping EventsService.EventsResponse)
}
...
class EventInteractor: EventInteractorProtocol {
    ...
    internal func getEvents(dislikedEvents: [Int], completion: @escaping EventsService.EventsResponse) {
        eventsService.getEvents(dislikedEvents: dislikedEvents, completion: completion)
    }
    /*
